...
class BossEffect:
    ...
    def update(effect,boss):
        if boss.state == 7: ##Intro
            ...
            effect.Tomb_DieFrame = (effect.Tomb_DieFrame + MOVEDUST_ACTION_PER_TIME + MOVEDUST_FRAMES_PER_ACTION * game_framework.frame_time)%7
    ...
    def draw(effect,boss):
        ...
        if boss.state == 7: #Tomb_Intro
            ...
            effect.Tomb_Die_img[int(effect.Tomb_DieFrame)].clip_compostie_draw(0,0,effect.Tomb_Die_img[int(effect.Tomb_DieFrame)].w,effect.Tomb_Die_img[int(effect.Tomb_DieFrame)].h,0,'n',boss.x,boss.y,effect.Tomb_Die_img[int(effect.Tomb_DieFrame)].w*2,effect.Tomb_Die_img[int(effect.Tomb_DieFrame)].h*2)
